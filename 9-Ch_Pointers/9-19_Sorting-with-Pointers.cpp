// This program shows the donations made to the United Cause by the employees of CK Graphics, Inc. It displays
// the donations in order from lowest to highest and in the original order they were received.
#include <iostream>
using namespace std;
...
int main()
{
  ...
  // Display the donations using the array or pointers. This will display them in sorted order.
