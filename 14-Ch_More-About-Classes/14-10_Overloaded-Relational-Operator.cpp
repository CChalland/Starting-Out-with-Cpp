// This program demonstrates the FeetInches class's overloaded relational operators.
#include <iostream>
...
int main()
{
  ...
  // Create two FeetInches objects. The default arguments for the constructor will be used.
