...
// The constructor accepts an argument for the number of sides for the die, and performs a roll.
...
// The getSides member function returns the number of for this die.
int Die::getSides()
{
  return sides;
}
