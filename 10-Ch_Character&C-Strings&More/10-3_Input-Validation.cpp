// This program calculates the area of a circle. It asks the user if he or she wishes to continue.
// A loop that demonstrates the toupper function until the user enters 'y', 'Y', 'n', or 'N'.
#include <iostream>
#include <cctype>
#include <iomanip>
using namespace std;
